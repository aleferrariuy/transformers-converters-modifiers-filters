...
Importar markdown (debe estar instalada previamente en el sistema)

Definir función convertir_md_a_html
  Abre y lee el archivo de entrada, .md
  Convierte Markdown a HTML utilizando la biblioteca markdown
  Escribe el archivo de salida conteniendo el HTML resultante
  Imprime mensaje de éxito

Control de errores
  Excepción
    Archivo no encontrado
      Imprime mensaje indicando que no se encontró el archivo de entrada .md
  Otras excepciones
    Imprime mensaje de error inesperado
    Sale con bandera de ejecución 1 a stdout

main

    Verificar se haya pasado un único archivo como argumento

    Verificar tipo de archivo recibido (md)

    Crea nombre de archivo de salida modificando la extensión a .out

    Llama a la función principal para realizar la conversión
